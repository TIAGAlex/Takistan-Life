...
*/
private["_message"];
if(__GETC__(life_adminlevel) < 2) exitWith {closeDialog 0; hint "You need to be an Admin to use this function.";};
//if(life_event) exitWith {closeDialog 0; hint "There is already a server event under-way.";};
//life_event = true;
_message = "This is not a test. This is your emergency broadcast system announcing the commencement of the Annual Purge sanctioned by This Is ArmA Government. If you do not want to participate, leave the city and run to the outskirts or stay in a small room inside your house. All Emergency Services must end their shift and go home.";[[_message,name player,6],"TON_fnc_clientMessage",true,false] spawn life_fnc_MP;
[[Tower1, "purge",500],"life_fnc_playSound",true,false] spawn life_fnc_MP;
