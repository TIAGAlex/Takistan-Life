...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
            ...
            case "methl": {"life_inv_methl"};   // into case 0 field 
			case "methm": {"life_inv_methm"};
			case "methb": {"life_inv_methb"};
		};
	};
	...
	case 1:
	{
		switch (_var) do
		{
            ...
            case "life_inv_methl": {"methl"}; // in the case 1 field 
			case "life_inv_methm": {"methm"};
			case "life_inv_methb": {"methb"};
		};
	};
};
