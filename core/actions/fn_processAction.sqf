...
_itemInfo = switch (_type) do
{
	...
	case "methl": {["methu","methl",1000,(localize "STR_Process_methl")]};
	case "methm": {["methu","methm",15000,(localize "STR_Process_methm")]};
    case "methb": {["methu","methb",20000,(localize "STR_Process_methb")]};	
