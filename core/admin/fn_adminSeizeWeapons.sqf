...
[[0,format["%1 had their weapons seized by an Admin! Let this be a lesson to you, %1.",_unit getVariable["realname",name _unit]]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;  
